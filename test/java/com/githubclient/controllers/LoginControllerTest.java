...
/*5. Метод testHandleLoginFailure:*/
    /* Проверяет неуспешную аутентификацию. Устанавливает пустые значения для имени пользователя и пароля и вызывает метод handleLogin. Проверяет, что сообщение об ошибке отображается.*/
